        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="rounded-full gap-2 text-red-500"
            >
            ...
            {editing ? (
              ...
              <>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <Button
                    onClick={handleSave}
                    disabled={loading}
                    className="bg-pink-500 hover:bg-pink-600 rounded-full gap-2"
                  >
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  {
                    label: 'Last Period',
                    value: user?.lastPeriodDate || 'Not set'
                  },
                  {
                    label: 'Cycle Length',
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {(user?.medicalConditions?.length || 0) > 0 ? (
                      ...
                      user?.medicalConditions?.map((c: string) => (
